...
MotorController::MotorController(int input_pin_1, int input_pin_2,
                                 int enable_pin)
    : _input_pin_1(input_pin_1), _input_pin_2(input_pin_2),
      _enable_pin(enable_pin), _speed(0) {}
...
signed char MotorController::get_speed() { return _speed; }

void MotorController::stop() { disable_engine(); }
...
void MotorController::disable_engine() { digitalWrite(_enable_pin, LOW); }

void MotorController::enable_engine() { digitalWrite(_enable_pin, HIGH); }
